...
class Contract(sp.Contract):
  def __init__(self):
    ...
    self.init(administrator = sp.address('tz1hdQscorfqMzFqYxnrApuS5i6QSTuoAp3w'),
              ...
              paused = False,
              token_metadata = {0 : sp.record(token_id = 0, token_info = {'decimals' : sp.bytes('0x3138'), 'icon' : sp.bytes('0x68747470733a2f2f736d61727470792e696f2f7374617469632f696d672f6c6f676f2d6f6e6c792e737667'), 'name' : sp.bytes('0x4d7920477265617420546f6b656e'), 'symbol' : sp.bytes('0x4d4754')})},
              totalSupply = 0)
